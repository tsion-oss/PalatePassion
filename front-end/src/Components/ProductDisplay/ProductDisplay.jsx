...
const ProductDisplay = (props) => {
    ...
    return (
        <section className='productdisplay md:flex md:flex-row flex-col md:justify-center sm:items-start mt-10 items-center justify-center'>
            ...
            <div className="productdisplay-right md:flex flex-col flex md:justify-start md:items-start items-center justify-center md:ml-10 gap-10">
                <div className="productdisplay-right-prices flex flex-col font-bold mt-2 gap-6">
                    <div className=''>
                        <Link className='' to={`/product/${product.id}`}>
                            <h1 onClick={window.scrollTo(0, 0)} className='text-gray-700 lg:text-3xl md:text-[25px] sm:text-[30px] text-[21px] font-bold active:text-red-500 hover:text-red-500'>{product.name}</h1>
                        </Link>
                    </div>
